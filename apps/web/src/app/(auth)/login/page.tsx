      ...
      <div className="w-full max-w-md animate-slide-up">
        ...
        <Card className="rounded-2xl border-border/50 shadow-xl shadow-black/5 dark:shadow-black/20 overflow-hidden">
          ...
          <CardHeader className="text-center pt-8 pb-2">
            ...
            <CardDescription className="text-muted-foreground/70">เข้าสู่ระบบเพื่อดูคลิปวิดีโอ</CardDescription>
          </CardHeader>
          <form onSubmit={handleSubmit}>
            ...
            <CardFooter className="flex flex-col gap-4 px-6 pb-8">
              ...
              <p className="text-sm text-muted-foreground">
                ยังไม่มีบัญชี?{" "}
                <Link href="/register" className="text-primary font-medium hover:underline transition-smooth">
                  สมัครสมาชิก
                </Link>
              </p>
            </CardFooter>
